...
urlpatterns = [
    ...
    path("admin/products/", AdminProductListCreateAPIView.as_view(), name="admin-product-create"),   
    path("admin/products/<int:pk>/",AdminProductRetrieveUpdateDeleteAPIView.as_view(),name="admin-product-detail"),
]
